...
```{r buttfig1, echo=FALSE, fig.cap="The trait–stressor matrix framework used for exposure–sensitivity analysis, reproduced from Fig. 1 in Butt et al. (2022)."}
...
1. Habitat loss
2. Invasive predators (cats)
3. Invasive herbivores (rabbits and goats)
4. Increased fire frequency
5. Collision (solar panels)
6. Collision (wind turbines)
...
m %>%
  mutate(
    ...
    birdcol_original = str_wrap(birdcol_original, 20),
    birdcol_new = str_wrap(birdcol_new, 20),
  ) %>%
  kbl(
