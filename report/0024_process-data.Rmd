...
In this study, aggregation methods were selected based on the context of species risk assessment. A combination of limiting-factor approaches (e.g., selecting the maximum value within a subgroup) and arithmetic means (allowing full compensation) was applied to reflect different ecological processes and risk dynamics.
